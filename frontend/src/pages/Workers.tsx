      ...
      <div className="bg-gn-surface/50 border border-gn-surface rounded-xl p-6 shadow-lg">
        <div className="flex justify-between items-center mb-6">
          <div className="relative w-64">
            ...
            <input type="text" placeholder="Search workers..." className="w-full bg-gn-blackLight border border-gn-surface rounded-lg pl-10 pr-4 py-2 text-white focus:outline-none focus:border-gn-gold" />
          </div>
        </div>
          ...
          <table className="w-full text-left text-gray-300">
            ...
            <tbody>
              <tr className="border-b border-gn-surface hover:bg-gn-blackLight/30">
                <td className="px-6 py-4" colSpan={5} style={{textAlign: "center"}}>No workers database rows yet. Backend fully connected!</td>
              </tr>
            </tbody>
          </table>
        </div>
